...
public class HumanBrain {
	...
	//TODO: Use these values to simulate non-human ethos i.e. sentient non-human feelings towards others 
	...
	//Have more things impacted by human relations: ability to influence/learn ethos, 
	//probabilities to do activities like chat and fight, and so on
