...
/**
 * Based off of the work in "Mean value coordinates for arbitrary planar
 * polygons", Hormann, Floater, 2006. Calculate barycentric coordinates (i.e.
 * 'polygon' coordinates) for arbitrary convex polygons.
 * 
 * @author Dante
 *
 */
