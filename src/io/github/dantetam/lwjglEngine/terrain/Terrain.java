...
public class Terrain {
	...
	public TerrainTexture worldBiomeBlendMap;

	public Terrain(int gridX, int gridZ, TerrainTexturePack texturePack,
			TerrainTexture blendMap, String heightMap)
	{
		this.texturePack = texturePack;
		this.worldBiomeBlendMap = blendMap;
		x = (float)gridX * SIZE;
		z = (float)gridZ * SIZE;
		model = generateTerrain(heightMap);
	}

	protected RawModel generateTerrain(String heightMapFileName)
	{
		if (heightMapFileName == null) return null;
