 ...
 * 
 * import org.lwjgl.util.vector.Vector2f; import org.lwjgl.util.vector.Vector3f;
 * 
 ...
 * 
 * private String textString; private float fontSize;
 * 
 * private int textMeshVao; private int vertexCount; private Vector3f colour =
 * new Vector3f(0f, 0f, 0f);
 * 
 * private Vector2f position; private float lineMaxSize; private int
 * numberOfLines;
 * 
 ...
 *//**
	 ...
	 */
/*
 * public GUIText(String text, float fontSize, FontType font, Vector2f position,
 * float maxLineLength, boolean centered) { this.textString = text;
 * this.fontSize = fontSize; this.font = font; this.position = position;
 * this.lineMaxSize = maxLineLength; this.centerText = centered;
 ...
 *//**
	 ...
	 */
/*
 * public void setColour(float r, float g, float b) { colour.set(r, g, b); }
 * 
 *//**
 ...
 *//**
	 ...
	 */
/*
 * public void setMeshInfo(int vao, int verticesCount) { this.textMeshVao = vao;
 ...
 *//**
	 ...
	 *//*
		 * protected String getTextString() { return textString; }
		 * 
		 * }
		 */