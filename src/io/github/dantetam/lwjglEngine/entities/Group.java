...
public class Group {
	...
	public CustomVector3f position = new CustomVector3f(0,0,0);
	...
	public Group(List<Entity> entities) {
	...
	public void move(CustomVector3f translation) {
	...
	{
		if (entities.size() == 0) return new float[] {0,0,0,0,0,0};
