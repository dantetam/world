package io.github.dantetam.lwjglEngine.shaders;
...
public class StaticShader extends ShaderProgram {
	...
	private static final String VERTEX_FILE = "src/io/github/dantetam/lwjglEngine/shaders/vertexShader.txt";
	private static final String FRAGMENT_FILE = "src/io/github/dantetam/lwjglEngine/shaders/fragmentShader.txt";
	...
	public void loadFastLighting(boolean fastLighting) {
		super.loadBoolean(locationFastLighting, fastLighting);
	}
